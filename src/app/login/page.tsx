...
export default function Login() {
    ...
    const { control, watch, formState: { errors, isValid }, handleSubmit } = useForm<LoginSchema>({
            ...
            <Card className={styles.card}>
                <CardContent className={styles.content}>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <Select label='Base' name='base' control={control} options={bases} onChange={(value) => getBaseStores(Number(value))} />
                        {!!watchBase && <>
                        ...
                        <CustomButton text='Entrar' type='submit' disabled={!watchBase || !watchStore} isLoading={isLoading} width="24rem" />
                    </form>
                </CardContent>
            </Card>
        </Container >
